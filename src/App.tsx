...
function App() {
    ...
    const addtask =(shoplistId:string, newTitle:string)=>{
        const newTovar = {id: v1(), title: newTitle, expectedPrice: '$1.99', realPrice: '$1.99', inCart: true}
        setThingsToBuy({...thingsToBuy, [shoplistId]: [newTovar, ...thingsToBuy[shoplistId]] })
    }
